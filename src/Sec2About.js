...
class Sec2About extends React.Component {
  ...
  return (
    <section className="section about" id="about">
      ...
      <div className="about-center container">
        <div className="left" data-aos="fade-right" data-aos-duration="2000">
          <img src={bg} alt="" className='about-img' />
        </div>
    ...
    to deliver coding excellence.
    I studied to be a Computer Engineer because I have always believed that technology 
    is the future of humanity and it will shape our lives in ways that we have only been 
    able to dream about.<span id="dots">...</span><span id="more"><br/> 
