      ...
      <div className="about-center container">
        ...
        <div className="right" data-aos="fade-left" data-aos-duration="2000">
          ...
          <p className="aboutme-p">
            ...
            I have always had a passion for learning new things and technologies. <span id="dots">...</span><span id="more">After the war started in Syria, I left for Lebanon and worked as IT support.
