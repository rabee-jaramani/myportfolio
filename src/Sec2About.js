...
class Sec2About extends React.Component {
  ...
  return (
    ...
    I studied to be a Computer Engineer because I have always believed that technology is the future of humanity and it will shape our lives in ways that we have only been able to dream about. . 
